...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="vendor/bootstrap/css/bootstrap.min.css?v=<?php echo filemtime('vendor/bootstrap/css/bootstrap.min.css');?>">
        <link rel="stylesheet" type="text/css" href="vendor/cruzersoftwares/css/style.css?v=<?php echo filemtime('vendor/cruzersoftwares/css/style.css');?>" />
