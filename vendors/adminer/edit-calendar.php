...
class AdminerEditCalendar {
	...
	*/
	function __construct($prepend = null, $langPath = "db/jquery-ui/i18n/jquery.ui.datepicker-%s.js") {
		if ($prepend === null) {
			$prepend = "<link rel='stylesheet' type='text/css' href='db/jquery-ui/jquery-ui.css'>\n"
				. script_src("db/jquery/jquery.js")
				. script_src("db/jquery-ui/jquery-ui.js")
				. script_src("db/jquery-ui/jquery-ui-timepicker-addon.js")
			;
		}
