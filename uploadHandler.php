...
class UploadHandler
{
    ...
    public function __construct($directory='', $options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            'upload_dir' => empty($directory) ? dirname(dirname($this->get_server_var('SCRIPT_FILENAME'))).'/': dirname(dirname($this->get_server_var('SCRIPT_FILENAME'))).'/'.$directory.'/',
            'upload_url' =>  empty($directory) ? $this->get_full_url_parent().'/' : $this->get_full_url_parent().'/'.$directory.'/' ,
            'file_dir' =>  $directory,
		...
		*/
            ...
            'print_response' => true
        ); //echo '<pre>';print_r($this->options);die('here');
        if ($options) {
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        if(isset($_REQUEST) && isset($_REQUEST['dir'])){
            return $this->options['upload_dir'].$_REQUEST['dir'].DIRECTORY_SEPARATOR.$this->get_user_path().$version_path.$file_name;
        } else{
    ...
    protected function set_additional_file_properties($file) {
        $file->filePath = $_REQUEST['directory'];
        $file->deleteUrl = $this->options['script_url']
            .$this->get_query_separator($this->options['script_url'])
            .$this->get_singular_param_name()
            .'='.rawurlencode($file->name).'&dir='.$_REQUEST['directory'];
    ...
    protected function validate($uploaded_file, $file, $error, $index) {
        ...
        if ($this->options['min_file_size'] && $file_size < $this->options['min_file_size']) {
            echo $file_size.'='.$this->options['min_file_size'];
