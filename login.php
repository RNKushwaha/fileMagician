...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="vendors/bootstrap/css/bootstrap.min.css?v=<?php echo filemtime('vendors/bootstrap/css/bootstrap.min.css');?>">
        <link rel="stylesheet" type="text/css" href="vendors/cruzersoftwares/css/style.css?v=<?php echo filemtime('vendors/cruzersoftwares/css/style.css');?>" />
    ...
    <form class="form-signin" method="post" accept="utf-8">
      ...
      <p class="mt-5 mb-3 text-muted text-center">Copyright &copy; <a href="https://www.cruzersoftwares.com" target="_blank">Cruzer Softwares </a> <?php echo date('Y');?></p>
    </form>
</body>
</html>
